...
namespace scitool {
    cardinal_cubic_bspline_interpolator::cardinal_cubic_bspline_interpolator(const std::vector<point> &points)
            : interpolator(points) {
    ...
    double cardinal_cubic_bspline_interpolator::operator()(double point) const {
